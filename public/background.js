...
chrome.webRequest.onHeadersReceived.addListener(
  (details) => {
    ...
    console.log(
      `Request: ${details.url}, Status: ${statusCode}, Tab: ${tabId}`
    ); // Debug
    ...
    if (tabId >= 0) {
      ...
      chain.push({
        ...
        statusCode: statusCode,
        type:
          statusCode >= 300 && statusCode < 400 ? "Redirect" : "Intermediate",
        timestamp: Date.now(),
      });
...
// Request complete pe final status add  aur storage mein save
